...
import com.university.mrmindedadmin.databinding.ActivityAddVideo2Binding;

import java.util.ArrayList;

public class addVideoActivity2 extends AppCompatActivity {
     private ActivityAddVideo2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAddVideo2Binding.inflate(getLayoutInflater());
        ...
        getOurCourse();
        adapters = new addVideo_Adapters(getApplicationContext(), course_arrayList);
