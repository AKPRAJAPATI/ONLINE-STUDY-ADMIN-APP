...
import com.university.mrmindedadmin.Application.video.addVideoAct;
...
public class addVideo_Adapters extends RecyclerView.Adapter<addVideo_Adapters.mainViewHolder> {


    private Context context;
    private ArrayList<courseModel> arrayList;

    public addVideo_Adapters(Context context, ArrayList<courseModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull mainViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, addVideoAct.class);
